...
Future<List<Spacecraft>> downloadJSON() async {
  final jsonEndpoint =
      "https://mocans09.000webhostapp.com/3.json";
...
class RecommedScreen extends StatelessWidget {
  static const String routeName = "/recommed";
  @override
  Widget build(BuildContext context) {
