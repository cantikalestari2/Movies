...
class Spacecraft {
  final String id;
  final String name, imageUrl, genre;
...
Future<List<Spacecraft>> downloadJSON() async {
  final jsonEndpoint =
      "https://mocans09.000webhostapp.com/1.json";
...
class _SecondScreenState extends State<SecondScreen> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(title: new Text('Detail Movie')),
      body: new Container(
         child: new Center(
            child: Column(
              children: <Widget>[
...
class JsonScreen extends StatelessWidget {
  static const String routeName = "/json";
  @override
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: new Scaffold(
        appBar: new AppBar(title: const Text('Top Rated Movies')),
        body: new Center(
